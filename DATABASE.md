...
权威定义：`supabase/migrations/202609070001_initial.sql` 及其后按文件名顺序的 `202609080001`–`202609080013` 增量迁移。
...
除初始迁移外，线上数据库必须按文件名顺序应用 `supabase/migrations/202609080001_*.sql` 到 `202609080017_*.sql`。不要只应用最新文件，也不要重复执行已记录的迁移。
