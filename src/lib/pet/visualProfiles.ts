...
export const CHARACTER_VISUAL_PROFILES: Record<CharacterId, CharacterVisualProfile> = {
  ...
  lion: defineProfile({
    id: 'lion',
    bodyBounds: { x: 4, y: 4, w: 73, h: 81 },
    headBounds: { x: 4, y: 4, w: 73, h: 46 },
    torsoBounds: { x: 16, y: 48, w: 49, h: 37 },
    faceCenter: { x: 40, y: 28 },
    leftEar: { x: 16, y: 12 },
    rightEar: { x: 64, y: 12 },
  ...
  seal: defineProfile({
    id: 'seal',
    bodyBounds: { x: 8, y: 6, w: 69, h: 79 },
    headBounds: { x: 8, y: 6, w: 69, h: 44 },
    torsoBounds: { x: 14, y: 48, w: 53, h: 37 },
    faceCenter: { x: 40, y: 28 },
    leftEar: { x: 20, y: 18 },
    rightEar: { x: 60, y: 18 },
    earStyle: 'none',
  ...
  elephant: defineProfile({
    id: 'elephant',
    bodyBounds: { x: 4, y: 6, w: 73, h: 79 },
    headBounds: { x: 4, y: 6, w: 73, h: 44 },
    torsoBounds: { x: 14, y: 48, w: 53, h: 37 },
    faceCenter: { x: 40, y: 26 },
    leftEar: { x: 14, y: 20 },
    rightEar: { x: 66, y: 20 },
    earStyle: 'round',
    skullTopY: 10,
  ...
  hedgehog: defineProfile({
    id: 'hedgehog',
    bodyBounds: { x: 6, y: 4, w: 71, h: 81 },
    headBounds: { x: 6, y: 4, w: 71, h: 46 },
    torsoBounds: { x: 16, y: 48, w: 49, h: 37 },
    faceCenter: { x: 40, y: 28 },
    leftEar: { x: 20, y: 12 },
    rightEar: { x: 60, y: 12 },
  ...
  monkey: defineProfile({
    id: 'monkey',
    bodyBounds: { x: 6, y: 6, w: 71, h: 79 },
    headBounds: { x: 6, y: 6, w: 71, h: 44 },
    torsoBounds: { x: 16, y: 48, w: 49, h: 37 },
    faceCenter: { x: 40, y: 27 },
    leftEar: { x: 14, y: 20 },
    rightEar: { x: 66, y: 20 },
